...
const metadata = {
    ...
    description: "Revolucione seu processo de recrutamento com entrevistas automatizadas via WhatsApp. Inteligência artificial que seleciona os melhores talentos.",
    generator: "v0.app",
    icons: {
        icon: [
            {
